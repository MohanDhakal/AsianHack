...
public class ViewAdapter extends RecyclerView.Adapter<ViewAdapter.ModelRecycleViewHolder> {
    Context mContext;
    List<ModelClass> itemList;

    public ViewAdapter(Context mContext, List<ModelClass> itemList) {
    ...
    @NonNull
    @Override
    public ViewAdapter.ModelRecycleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.hotel_items, parent, false);
        return new ViewAdapter.ModelRecycleViewHolder(v);
    }
